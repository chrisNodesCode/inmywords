  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap" }}>
        <span
          style={{ fontFamily: "var(--imw-font-ui)", fontSize: "0.7rem", fontWeight: 600, color: "var(--imw-ac-d)" }}
        >
          {displayTitle}
        </span>
        ...
        {(entry.isChildhoodMemory || entry.isFunctionalImpairment) && (
...
export default function EvalPrepPage() {
        ...
        <div style={{ width: "100%", maxWidth: 720 }}>
          ...
          <div style={{ paddingTop: 36, marginBottom: 32 }}>
            ...
            <p style={{ fontFamily: "var(--imw-font-ui)", fontSize: "0.85rem", color: "var(--imw-text-secondary)", margin: "0 0 20px", lineHeight: 1.5 }}>
              Your journal, organized by DSM-5 criterion. Only a qualified clinician can diagnose.
            </p>
